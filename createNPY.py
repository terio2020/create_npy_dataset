...
INPUT_DATA = r'G:\Five_Flower'     # 原始输入数据的目录，其有五个子目录，每个目录下保存属于该类别的所有图片
OUTPUT_DATA = r'G:\Five_Flower.npy'     # 将整理后的图片数据通过numpy的格式保存
...
def create_image_lists(sess, testing_percentage, validation_percentage):
    ...
    for sub_dir in sub_dirs:
        ...
        for file_name in file_list:
            ...
            image = tf.compat.v1.image.resize_images(image, [178, 218])
